...
<nav class="navbar navbar-default title1">
	...
	<main>
		<div class="container" id="rcorners1">
			<h2 style="font-family:Verdana">You're Done!</h2>
				<p style="font-family:Verdana">Congrats! You have completed the test</p>
				<p style="font-family:Verdana">Final Score: <?php echo $_SESSION['score']; ?></p>
				<a href="question.php?n=1" class="start" style="font-family:Verdana">Take Again</a>
		</div>
	</main>
